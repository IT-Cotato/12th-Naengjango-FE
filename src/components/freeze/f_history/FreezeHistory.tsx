...
export default function FreezeHistory() {
  ...
  const [item, setItem] = useState<FreezeItem[]>([
    {
      id: 1,
      image: 'https://placehold.co/54x54',
      title: '바지',
      price: 57000,
      remainingHour: 24,
      checked: false,
    ...
    <>
      ...
      >
        <div
          ...
          ref={listRef}
          className="Frame48096442 w-[287px] left-[20px] top-[99px] absolute inline-flex flex-col justify-start items-start gap-4 max-h-[360px] overflow-y-scroll overflow-x-hidden freeze-scroll"
        >
