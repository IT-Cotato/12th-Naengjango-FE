  ...
  return (
    <>
      ...
      >
        <div
          data-layer="Frame 25"
          className="Frame25 w-full h-[488px] fixed bottom-0 left-1/2 -translate-x-1/2 bg-white-800 rounded-tl-[30px] rounded-tr-[30px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.30)] overflow-hidden"
